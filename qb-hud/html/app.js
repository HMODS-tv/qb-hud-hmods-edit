  ...
  methods: {
    hudTick(data) {
      ...
      if (data.playerDead === false) {
        this.healthColor = "#005e13";
      } else {
        this.healthColor = "#ff000040";
        this.health = 100;
      }
      ...
      if (data.armor <= 0) {
        this.armorColor = "#002e6b";
      } else {
        this.armorColor = "#133d78";
      }
      ...
      if (data.talking && data.radio) {
        this.talkingColor = "#ff4545";
      } else if (data.talking) {
        this.talkingColor = '#ff7b00b6';
      } else {
        this.talkingColor = "#525252";
      }
  ...
  methods: {
    vehicleHud(data) {
      ...
      if (data.fuel <= 20) {
        ...
        this.fuelColor = "#ff4a4a";
      } else {
        this.fuelColor = "#598f1d";
      }
